...
public class CheckScanner {
    ...
    /**
     * Check whether or not it is valid to move a piece, so it wouldn't result its king to be checkec
     * @param move
     * @return true if moving the move.piece will get the king to be checked because it was pinned to that piece in the first place
     */
